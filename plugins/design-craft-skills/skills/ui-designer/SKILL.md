...
- **Interface text (copywriting)** is a separate concern. This skill provides
  the visual system; the actual words inside components — error messages,
  labels, empty states — deserve a dedicated copywriting pass.
